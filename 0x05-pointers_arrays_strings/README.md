...
A good engineer thinks in reverse and asks himself about the stylistic consequences 
...
to be printed Numbers must be separated by comma, followed by a space The numbers should be displayed 
in the same order as they are stored in the array You are allowed to use printf
strcpy
...
the people to save the number Write a function that convert a string to an integer.
...
the function must return 0 You are not allowed to use long You are not allowed to declare new variables of “type” array 
