...
/**
 * print_class - Prints class of a ELF header.
...
/**
 * print_abi - Prints ABI version of a ELF header.
 * @e_ident: pointer to array contains ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_type: ELF type.
 * @e_ident: pointer to array contains ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * Return: 0 on success.
 *
 * Description: If file is not a ELF File or
